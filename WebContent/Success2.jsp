...
<table border="1">
<tr>
<td colspan="2"><b>Source Account</b></td><td colspan="2"><b>Target Account</b></td>
</tr>
<tr>
<td>Old Balance</td><td>New Balance</td><td>Old Balance</td><td>New Balance</td>
</tr>
<tr>
<td><%=list[0] %></td><td><%=(list[0]-list[2]) %></td><td><%=list[1] %></td><td><%=(list[1]+list[2]) %></td>
</tr>
<!--  <p><b>Old Balance is :<%=list[0] %><br>
<p><b>New Balance is :<%=list[1] %><br>-->
</table>
