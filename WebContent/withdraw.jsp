...
<img id="myImg" src="Images/with.jpg" width="1400" height="200">
...
<div class="container">
  ...
  <form class="form-horizontal" name="formname" action="ServletAction" method="post" onsubmit="return validate()">
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="accid" placeholder="Enter AccountId" name="accountId">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-success" name="action" value="withdraw">Submit</button>
      </div>
    </div>
  </form>
</div>
