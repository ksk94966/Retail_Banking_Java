...
<body>
	...
	<div class="main">
		...
		<form class="form-horizontal" action="SearchController" method="post">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-1">
        <button class="btn btn-success" type="submit" name="action" value="searchCustomer" onClick="return validation();">VIEW</button>
      </div>
