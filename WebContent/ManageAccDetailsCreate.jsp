...
<body>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-5">
        <input type="text" class="form-control" placeholder="Please enter Amount" name="DepAmt" id="DepAmt">
      </div>
    </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-1">
        <button class="btn btn-success" type="submit" name="action" value="addAccount" onClick="return createAccountValidation();">Submit</button>
      </div>
